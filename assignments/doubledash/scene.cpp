...
Scene::Scene()
{
    ...
    wave = std::make_unique<ew::Texture>("assets/Textures/windwaker/water32.png");
    wave2 = std::make_unique<ew::Texture>("assets/Textures/windwaker/water16.png");
    wave3 = std::make_unique<ew::Texture>("assets/Textures/windwaker/water8.png");
